...
# Add title and subtitle
fig.add_artist(plt.Line2D([0.09, 0.09], [0.79, 0.93], linewidth=6, color='#203764', solid_capstyle='butt'))
plt.text(0.02, 1.18, f'The Human Cost Of Israeli-Palestinian Conflict', fontsize=16, fontweight='bold', ha='left', transform=plt.gca().transAxes)
plt.text(0.02, 1.11, f'Israeli & Palestinian deaths since October 2023', fontsize=11, color='#262626', ha='left', transform=plt.gca().transAxes)
plt.text(0.02, 1.04, f'(number of fatalities)', fontsize=9, color='#262626', ha='left', transform=plt.gca().transAxes)
